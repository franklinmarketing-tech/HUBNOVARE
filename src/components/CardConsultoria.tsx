  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2">
        ...
        {item.isIsca ? (
          <span className="inline-flex items-center gap-1 rounded-full bg-emerald-100/90 px-2.5 py-1 text-[11px] font-semibold text-emerald-800 shadow-2xs">
            <Sparkles className="h-3.5 w-3.5 text-emerald-600" />
            100% Grátis
          </span>
        ) : item.coBranding ? (
          <span className="inline-flex items-center gap-1 rounded-full bg-blue-100/90 border border-blue-200/60 px-2.5 py-1 text-[11px] font-semibold text-blue-900 shadow-2xs">
