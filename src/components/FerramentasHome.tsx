  ...
  return (
    <section className="cine" style={{ transitionDelay: "420ms" }}>
      <div className="flex items-baseline justify-between gap-3">
        ...
        <Link
          href="/aplicativos"
          className="inline-flex items-center gap-1 text-xs font-semibold text-accent-strong underline-offset-2 hover:underline"
        >
          Ver todas
            ...
            <li key={href} className="group/i relative">
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  <span className="block truncate font-display text-xs font-semibold leading-tight text-primary">
                    {nome}
                  </span>
