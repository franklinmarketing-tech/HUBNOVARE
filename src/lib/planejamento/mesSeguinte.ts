...
// CÓPIA de novareapp/src/lib/monthlyClone.ts, com uma troca: lá o cliente do
// Supabase é um singleton do Vite; aqui ele é criado por chamada.
//
// A lógica NÃO foi alterada. Ela já era determinística e idempotente — o que
// faltava no produto original não era a função, era o gatilho: só o botão do
