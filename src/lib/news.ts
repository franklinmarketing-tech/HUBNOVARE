...
export const ARTIGOS: Artigo[] = [
  ...
  {
    slug: "vida-plan-o-plano-de-vida-em-um-numero-so",
    titulo: "Vida Plan: seu projeto de vida virou um número só",
    resumo:
      "Independência financeira mais todos os seus sonhos, a valor de hoje: o Marco Horizonte é o número que resume o plano inteiro — e mostra exatamente quanto falta.",
    categoria: "ia",
    data: "2026-08-01",
    tempoLeituraMin: 5,
    ...
    destaque: true,
    corpo: [
      "A maioria dos planos financeiros fica solto: uma meta de aposentadoria aqui, um sonho de viagem ali, sem conexão entre as partes. O Vida Plan resolve isso condensando tudo — a independência financeira e cada sonho — num único número: o Marco Horizonte.",
      "É a soma do que você precisa para nunca mais depender do trabalho, mais o custo de cada objetivo de vida, tudo trazido a valor de hoje. Com esse número em mãos, a pergunta deixa de ser vaga ('estou indo bem?') e vira concreta: falta tanto, no ritmo atual chega em tantos anos, e para acelerar precisa de tanto a mais por mês.",
      "O app projeta ano a ano até esse ponto, e o plano de ação sai pronto: quanto aportar, em qual prazo, com sugestão de carteira por horizonte. Tudo educativo — a recomendação personalizada de produto continua sendo trabalho de um consultor humano.",
      "Dá para entrar sem cadastro nenhum: a primeira sessão do Vida Plan já abre com uma conta de demonstração, só para conhecer por dentro antes de decidir se vale continuar.",
    ],
    ferramenta: {
      slug: "vida-plan",
      nome: "Entrar no Vida Plan",
